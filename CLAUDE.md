# CLAUDE.md — Bootstrap Loader for Claude Code
...
เมื่อเปิด Claude Code ใน repo นี้ ให้โหลดตามลำดับ:

1. **อ่าน** `docs/AI_CONTEXT.md` — core brain ของ project
2. **อ่าน** `.ragnar/agents/common.md` — shared behavioral contract
3. **อ่าน** `.ragnar/agents/claude_adapter.md` — Claude-specific instructions
